...
def fetch_article():
    ...
    article = {
        ...
        'articleInfo': {
            'header': "Sywek Article Header",
            'secondHeader': "Sywek second header try write somthing here , and bilv sdkfs sdnfks sdkfnsd ksdf .",
            'tags': ["web", "html", "javascript", "flask", "python"],
            'postDateTime': {
                'date': "07/01/2020",
                'time': "17:12",
                'GMT': 8,
        ...
        'sections': [
                ...
                'contentElements': [
                    {
                        ...
                        'content': {'text': "A. Section 0-0 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "header",
                        'content': {'text': "1. Section 0-1 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "text",
                        'content': {
                            'text':
                            "&nbsp;&nbsp;&nbsp;&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio molestiae saepe doloremque eos, dignissimos magnam fuga deserunt nemo molestias ratione nostrum laborum, consequuntur tempore! Adipisci iste odio fugiat dolor esse?",
                        },
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "header",
                        'content': {'text': "2. Section 0-2 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "text",
            ...
            },
            {
                'contentElements': [
                    {
                        'contentType': "subTitle",
                        'content': {'text': "B. Section 1-0 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "header",
                        'content': {'text': "1. Section 1-1 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "text",
                    ...
                    {
                        'contentType': "video",
                        'content': {'videoUrl': "https://www.youtube.com/embed/sXQxhojSdZM"},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "header",
                        'content': {'text': "2. Section 1-1 text content."},
                        'jumpLines': 0,
                    },
                    {
                        'contentType': "text",
